...
**Resolution divergence** (`gai doctor` per-domain reality check) - last run `2026-09-20 10:17 UTC`
> 96 divergence(s) in the last 25 days across 14 tracked domains -- most recent on 2026-09-20.
> _(mostly anycast/GeoDNS edges disagreeing between two queries -- [full per-domain log for 2026-09-20](https://github.com/casablanque-code/casablanque-code/blob/main/.radar/raw-20260920.log))_
